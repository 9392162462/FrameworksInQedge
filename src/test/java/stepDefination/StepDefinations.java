...
@When("Wait for Purchases link with {string} and {string}")
public void wait_for_Purchases_link_with_and(String LocatorType, String LocatorValue) {
	FunctionLibrary.waitForElement(LocatorType, LocatorValue, "10");
}

@When("Click Purchases link with {string} and {string}")
public void click_Purchases_link_with_and(String LocatorType, String LocatorValue) {
	FunctionLibrary.clickAction(LocatorType, LocatorValue);
}

@When("Wait for Purchases Number with {string} and {string}")
public void wait_for_Purchases_Number_with_and(String LocatorType, String LocatorValue) {
	FunctionLibrary.waitForElement(LocatorType, LocatorValue, "10");
}

@When("Capture Purchases number with{string} and {string}")
public void capture_Purchases_number_with_and(String LocatorType, String LocatorValue) throws Throwable {
	FunctionLibrary.captureCus(LocatorType, LocatorValue);
}
